  ...
  return (
    <div className="max-w-7px px-12 py-10 ">
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 ">
        <div className=" bg-[#ffdfdf]  h-[300px] overflow-hidden flex justify-center items-center relative lg:p-10 p-1 hover:shadow-lg">
          <img src={img2} alt="" />
          <div className=" absolute top-50 right-2 space-y-2 lg:pr-5">
        ...
        <div className="relative lg:p-10 p-1 bg-[#fff08a]  h-[300px] overflow-hidden flex justify-center items-center hover:shadow-lg">
